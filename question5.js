...
console.log(`The duplicate numbers are ${duplicateNumber([1,4,3,4,5,7,7,8,9,10])}`);
console.log(`The duplicate numbers are ${duplicateNumber([1,4,4, 8, 8,8,8, 9, 10 ,11, 12, 12, 13])}`);