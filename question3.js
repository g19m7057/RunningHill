...
console.log(
  anagram("Army", "Mary")
    ? "Army is an anagram with Mary."
    : "Army is not an anagram with."
);
console.log(
  anagram("Sifiso", "OsifiS")
    ? "Sifiso is an anagram with OsifiS."
    : "Sifiso is not an anagram with OsifiS."
);
console.log(
  anagram("taBle", "Tafel")
    ? "taBle is an anagram with Tafel."
    : "taBle is not an anagram with Tafel."
);
